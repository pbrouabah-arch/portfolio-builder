...
export default function Seal({ className = "", rotate = -6 }: SealProps) {
  return (
    ...
    >
      <circle cx="50" cy="50" r="46" fill="#DCE6F8" opacity="0.9" />
      <circle cx="50" cy="50" r="46" fill="none" stroke="#B7CBEE" strokeWidth="1.5" />
      <circle cx="50" cy="50" r="37" fill="none" stroke="#B7CBEE" strokeWidth="1" strokeDasharray="2 4" />
      <g fill="none" stroke="#8FAEE0" strokeWidth="1.4" strokeLinecap="round">
