...
export default function Sprig({ className = "" }: SprigProps) {
  return (
    ...
    >
      ...
      <circle cx="22" cy="8" r="2.6" fill="#F5F9FF" />
      <circle cx="14" cy="16" r="2" fill="#F5F9FF" />
      <circle cx="30" cy="18" r="2" fill="#F5F9FF" />
      <circle cx="10" cy="46" r="1.8" fill="#F5F9FF" />
      <circle cx="48" cy="26" r="1.8" fill="#F5F9FF" />
      <circle cx="26" cy="30" r="2" fill="#F5F9FF" />
    </svg>
  );
}
